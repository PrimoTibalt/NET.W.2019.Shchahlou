...
namespace NET.W._2019.Shchahlou._6
{
    ...
    {
        delegate bool DoBubble(int[] n1, int[] n2);
        ...
        {
            bool BiggestSum(int[] arr1, int[] arr2)
            {
        ...
        {
            bool SmallestSum(int[] arr1, int[] arr2)
            {
                return arr1.Sum() < arr2.Sum();
            }
        ...
        {
            bool BiggestElementIncrease(int[] arr1, int[] arr2)
            {
        ...
        {
            bool BiggestElementDecrease(int[] arr1, int[] arr2)
            {
                int biggest1 = Int32.MinValue;
                int biggest2 = Int32.MinValue;
                foreach (int val1 in arr1)
        ...
        {
            bool MinElementIncrease(int[] arr1, int[] arr2)
            {
        ...
        {
            bool MinElementDecrease(int[] arr1, int[] arr2)
            {
                int smallest1 = Int32.MaxValue;
                int smallest2 = Int32.MaxValue;
                foreach (int val1 in arr1)
